...
var CryptoKey = (function () {
    ...
    Object.defineProperty(CryptoKey.prototype, "key", {
        get: function () {
            return this._key;
        },
        enumerable: true,
    ...
    CryptoKey.prototype.initPrivateKey = function (key) {
        this._key = key;
    ...
    CryptoKey.prototype.initPublicKey = function (key) {
        this._key = key;
    ...
    CryptoKey.prototype.initSecretKey = function (key) {
        this._key = key;
